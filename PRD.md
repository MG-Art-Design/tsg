...
### Strategic Positioning AI - Enhanced (Geopolitical Focus)
- **Functionality**: AI-powered analysis of the top 5 ongoing geopolitical strategic moves from countries where the USA is the #1 choice in their grouping. Each move is distilled to a short headline covering who, what, when, and how, with triple-verified sources and full breakdowns including AI reasoning for the synopsis. All information is framed as conjecture with a disclaimer that TSG is not liable for real-world decisions made based on this information.
- **Purpose**: Provides users with strategic geopolitical intelligence that may impact market sectors and investment decisions, transforming complex international developments into digestible insights with full transparency about sources and AI synthesis process
- **Trigger**: Accessed via "Strategic AI" tab within Insights section; analysis auto-generates on first load and can be refreshed manually
- **Progression**: Navigate to Insights → Select "Strategic AI" tab → View automatically generated 5 geopolitical moves → Each move shows short headline (who/what/when/how), summary, impact level badge, confidence score, and affected market sectors → Click any move to open detailed breakdown dialog → View full analysis with 4-5 paragraphs of context and implications → Read "AI Reasoning & Synthesis" section explaining how the AI arrived at the synopsis (2-3 paragraphs) → Review triple-verified sources with verification status badges (verified/partial/pending) → See complete list of affected market sectors → Read disclaimer at bottom of section about conjecture and liability → Close dialog or click another move to explore
- **Success criteria**: Exactly 5 geopolitical moves generated each session covering USA-focused strategic positioning, each headline is 12 words or less and captures who/what/when/how, summaries are 2-3 sentences, full analysis is 4-5 paragraphs, AI reasoning explains synthesis process in 2-3 paragraphs, three sources listed per move with verification status, market sectors (2-4) listed for each move, confidence scores range 60-95%, geopolitical impact levels (high/medium/low) assigned correctly, disclaimer visible at bottom stating TSG is not liable for decisions made from this information, detailed breakdown dialog displays all information in organized sections, can refresh analysis to generate new moves, maintains distinctive gold-themed design, moves are clickable with arrow indicators
